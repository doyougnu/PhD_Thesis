...
\begin{figure}
  ...
  \vspace{-2ex}
  \caption{Possible plain models for variants of \TODO{do}\ldots{}.}%
...
For example, consider the query formula \TODO{plug}\ldots{} from the
...
disjuncted terms, \todo{remove references the linux example}one
...
$C_{FT}$'s configuration is converted to \todo{fix}%$\neg \LOne{} \wedge \LTwo{}$. This
