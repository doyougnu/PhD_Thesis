...
called \emph{presence conditions} following the work on TypeChef. Furthermore,
annotations which are not attached but describe possible variants are called
