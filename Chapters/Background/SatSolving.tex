...
s-expression of argument sorts \lstinline{()}; which is empty in this case, a
return sort; \lstinline{Bool} and the body of the function.
...
Notice that the example asserts \lstinline{not peirce-is-ex-middle} rather than
...
counter-example to the theorem. If no model exists---that is \rn{unsat} is
