  \begin{tikzcd}[column sep=8cm,row sep=3cm]
    \kf{f} \arrow[r, Rightarrow, "\ensuremath{\sem[C]{f} = \prime*{f}}"] %\arrow[r, shift left] \arrow[r, shift right]
    \arrow[d, swap, "VSAT(f)"] &
    \prime*{f} \arrow[d, Rightarrow, "SAT(\prime*{f})"]  \\
    \vmodel*{f}  \arrow[r, Rightarrow, "\submodel{f}{C}"]
                 % \arrow[r, shift left]
                 % \arrow[r, shift right]
    &  \rn{\large sat}
  \end{tikzcd}
