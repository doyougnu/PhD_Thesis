...
\inferrule*[right=\acNotS]
  ...
  {(\aStore{}, \eAR) \accumulation (\aStore{}', s) \\
    \pwrap{\integerUnary}(\aStore{}', s) = (\aStore{}'', s') }
  { (\aStore{}, \integerUnary\; \eAR) \accumulation (\aStore{}'', s') }

\inferrule*[right=\acBoolS]
 {(\aStore{}, \eIL*{1}) \accumulation (\aStore{1}, s_1) \\
    (\aStore{1}, \eIL*{2}) \accumulation (\aStore{2}, s_2) \\
     \pwrap{\boolFuncs}(\aStore{2}, s_1, s_2) = (\aStore{3}, s_3) }
  { (\aStore{}, \eIL*{1}\; \boolFuncs\; \eIL*{2}) \accumulation{} (\aStore{3}, s_3) }

  \inferrule*[right=\acArithS]
  { (\aStore{}, \eAR*{1}) \accumulation (\aStore{1}, s_1) \\
    (\aStore{1}, \eAR*{2}) \accumulation (\aStore{2}, s_2) \\
    \pwrap{\integerFuncs}(\aStore{2}, s_1, s_2) = (\aStore{3}, s_3) }
  { (\aStore{}, \eAR*{1}\; \integerFuncs\; \eAR*{2}) \accumulation{} (\aStore{3}, s_3) }

  \inferrule*[right=\acInEqS]
  {(\aStore{}, \eAR*{1}) \accumulation (\aStore{1}, s_1) \\
    (\aStore{1}, \eAR*{2}) \accumulation (\aStore{2}, s_2) \\
    \pwrap{\inequalities}(\aStore{2}, s_1, s_2) = (\aStore{3}, s_3) }
  { (\aStore{}, \eAR*{1}\; \inequalities\; \eAR*{2}) \accumulation{} (\aStore{3}, s_3) }
